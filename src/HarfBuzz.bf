...
namespace FreeType
{
	static class HarfBuzz
	{
		...
		const hb_tag_t HB_TAG_NONE = HB_TAG(0,0,0,0);
		const hb_tag_t HB_TAG_MAX_SIGNED = HB_TAG((char8)0x7f,(char8)0xff,(char8)0xff,(char8)0xff);
		...
		[CLink]
		public static extern hb_language_t hb_language_from_string([MangleConst]char8* str, int len);
		
		public struct hb_blob_t;
		
		[CLink]
		public static extern hb_blob_t* hb_blob_create_from_file([MangleConst]char8* file_name);
		...
		*/
		...
		public typealias hb_position_t = uint32;
